...
const Heroes = () => {
  return (
    ...
    >
      <section className="w-11/12 sm:w-4/5 md:w-3/4 lg:w-2/4 h-auto sm:h-2/3 p-4 sm:p-6 md:p-8 text-center bg-red-400 flex flex-col justify-evenly items-center"
      >
        ...
        <div className="w-full sm:w-1/2 md:w-2/5 h-16 bg-amber-300 flex justify-around items-center"
        >
