...
const Header = () => {
  return (
    <div className="flex justify-between items-center bg-zinc-200 h-20 w-full shadow-md">
      ...
      <nav className="h-full w-3/6 flex items-center justify-center"> 
            <ul className="list-none flex items-center justify-around w-full cursor-pointer">
              ...
              <li className="hover:text-teal-400 hover:scale-110 transform transition duration-300">About Us</li>
